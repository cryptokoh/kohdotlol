...
╚════════════════════════════════════════════════════════╝
      ...
      <section className="projects-section" id="projects">
        ...
        <div className="project-showcase">
          <div className="project-card daedalus">
            ...
            <div className="project-description">
              <p>A stunning web-based desktop environment that brings the power of a full operating system to your browser. Built with React and TypeScript.</p>
            </div>
            
            <div className="project-features">
              <div className="feature-item">
                <span className="feature-icon">🎨</span>
                <span>Beautiful UI with multiple themes</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">📁</span>
                <span>Virtual file system with drag & drop</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">🪟</span>
                <span>Windowed applications & multitasking</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">🎮</span>
                <span>Built-in games & productivity apps</span>
              </div>
            </div>
            ...
            <div className="project-tech-stack">
              ...
              <span className="tech-badge">IndexedDB</span>
            </div>
            
            <div className="project-links">
              <a href="https://dustinbrett.com" target="_blank" rel="noopener noreferrer" className="project-link demo">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zM6 20V4h7v5h5v11H6z"/>
                </svg>
                Live Demo
              </a>
              <a href="https://github.com/DustinBrett/daedalOS" target="_blank" rel="noopener noreferrer" className="project-link github">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">

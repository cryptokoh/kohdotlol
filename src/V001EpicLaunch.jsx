...
export default function V001EpicLaunch() {
  ...
  return (
    <div className="min-h-screen w-screen text-white overflow-x-hidden relative" onMouseMove={handleMouseMove}>
      {/* Archive Banner */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-purple-900/90 to-pink-900/90 backdrop-blur-sm border-b border-purple-500/30">
        <div className="flex items-center justify-center py-2 px-4">
          ...
          >
            ...
            <span className="text-gray-300">ARCHIVED BUILD</span>
            <span className="text-purple-400 font-bold">v0.0.1</span>
            <span className="text-gray-500">•</span>
            <span className="text-pink-400">EPIC LAUNCH EDITION</span>
          </motion.div>
        </div>
      </div>
      ...
      {/* Add top padding for the archive banner */}

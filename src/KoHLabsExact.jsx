...
╚════════════════════════════════════════════════════════╝
      ...
      <section className="projects-section" id="projects">
        ...
        <div className="project-showcase">
          <div className="project-card regenia">
            <div className="project-header">
              <h3 className="project-title">
                <span className="project-icon">🤖</span>
                Regenia × Hand Protocol
              </h3>
              <span className="project-status">DEPLOYED</span>
            </div>
            
            <div className="project-description">
              <p>Provided 16 regenerative AI agents powered by Eliza OS for the Hand Protocol ecosystem. A year-long commitment to building autonomous agents that help coordinate regenerative actions and community initiatives.</p>
            </div>
            ...
            <div className="project-features">
              ...
              <div className="feature-item">
                <span className="feature-icon">🌱</span>
                <span>Regenerative coordination & impact</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">⚡</span>
                <span>Powered by Eliza OS framework</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">🔄</span>
                <span>Autonomous 24/7 operations</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">🤝</span>
                <span>Multi-agent collaboration system</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">📊</span>
                <span>Real-time community engagement</span>
              </div>
            </div>
            
            <div className="project-tech-stack">
              <span className="tech-badge">Eliza OS</span>
              <span className="tech-badge">TypeScript</span>
              <span className="tech-badge">AI/ML</span>
              <span className="tech-badge">Discord.js</span>
            ...
            <div className="project-links">
              <a href="https://x.com/RegeniaRose" target="_blank" rel="noopener noreferrer" className="project-link demo">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
                Regenia on X
              </a>
              <a href="https://github.com/elizaos/eliza" target="_blank" rel="noopener noreferrer" className="project-link github">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://hand.social" target="_blank" rel="noopener noreferrer" className="project-link hand">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="project-stats">
              ...
              <div className="stat-item">
                <span className="stat-value">365 Days</span>
                <span className="stat-label">Commitment</span>
              </div>
              <div className="stat-item">
                <span className="stat-value">24/7</span>
                <span className="stat-label">Autonomous Ops</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="chain-boxes">
          ...
          <div className="chain-box base-box">
            ...
            <div className="chain-buttons">
              ...
              <a href="https://retake.tv" target="_blank" rel="noopener noreferrer" className="chain-button">
                Retake.tv
              </a>
            </div>
          </div>
          <div className="chain-box zora-box">
            <div className="chain-label">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            <h3>$koH/$ZORA</h3>
            <p className="chain-description">Creator coin launched on Zora.co</p>
            <div className="chain-buttons">
              <a href="https://zora.co/@koh" target="_blank" rel="noopener noreferrer" className="chain-button">
                View on Zora.co
              </a>
              <a href="https://zora.co/collect/zora:0x577dCA90068DB5A60782112823bABB32333CC88A" target="_blank" rel="noopener noreferrer" className="chain-button">
                Collect Creator Coin
              </a>
            </div>
          </div>
        </div>
